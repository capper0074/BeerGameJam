...
namespace GameJam.Graphic
{
    public static class Sound
    {
        ...
        {
            player.URL = @"C:\Skole\BeerGameJam\GameJam\Graphic\Sounds\Boss_Sound.mp3 "; //Sæt jeres egen file path ind. Kan ikke få en relative til at virke
            player.controls.play();
        }

        public static void BeerRun()
        {
            player.URL = @"C:\Skole\BeerGameJam\GameJam\Graphic\Sounds\BeerRun_Sound.mp3"; //Sæt jeres egen file path ind. Kan ikke få en relative til at virke
            player.controls.play();
        }

        public static void EatSound()
        {
            player.URL = @"C:\Skole\BeerGameJam\GameJam\Graphic\Sounds\Eating_Sound.mp3"; //Sæt jeres egen file path ind. Kan ikke få en relative til at virke
            player.controls.play();
        }

        public static void LoseSound()
        {
            player.URL = @"C:\Skole\BeerGameJam\GameJam\Graphic\Sounds\Lose_Sound.mp3"; //Sæt jeres egen file path ind. Kan ikke få en relative til at virke
            player.controls.play();
        }

        public static void Waiting_Sound()
        {
            player.URL = @"C:\Skole\BeerGameJam\GameJam\Graphic\Sounds\Waiting_Sound.mp3"; //Sæt jeres egen file path ind. Kan ikke få en relative til at virke
            player.controls.play();
        }
